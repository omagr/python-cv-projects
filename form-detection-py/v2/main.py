...
import numpy as np
import mapper
image=cv2.imread("saqmple_1.jpg")   #read in the image
image=cv2.resize(image,(500,500)) #resizing because opencv does not work well with bigger images
orig=image.copy()
...
contourframe = cv2.drawContours(contourframe, contours, -1, (255, 0, 255), 7)
cornerframe = image.copy()
contourframe=cv2.resize(contourframe, (500,500))
#maxaera = 0
#biggest = []
